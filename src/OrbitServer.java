...
public class OrbitServer
    ...
    public OrbitServer(int askport, boolean passwords, boolean newusers,
        ...
        if (graphics) {
            myWindow =
                    new OrbitServerWindow(this, "Orbit Chat v"
    ...
    protected void shutdown() {
        ...
        if (!graphics) {
            System.out.println("");
            System.out.println("Orbit server shutdown complete");
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            server.myURL = new URL("file", "localhost", "./"); // change localhost to ip address and make your system a server. Then,
            //you will be able to chat across different systems.
        } catch (Exception E) {
